...
import { ColumnType, GridConfig, CustomDataSource, NgxServerSideMatGridComponent } from 'ngx-server-side-mat-grid';
...
export class AppComponent implements OnInit {
  ...
  @ViewChild('employeeGrid') employeeGrid!: NgxServerSideMatGridComponent;
