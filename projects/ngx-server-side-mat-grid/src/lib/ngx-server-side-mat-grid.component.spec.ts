...
describe('NgxServerSideMatGridComponent - TestWrapperComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [NgxServerSideMatGridComponent, TestWrapperComponent],
      providers: [
        {
          provide: DatePipe,
          useValue: {
...
describe('NgxServerSideMatGridComponent', () => {
  let component: NgxServerSideMatGridComponent;
  let fixture: ComponentFixture<NgxServerSideMatGridComponent>;
  let loader: HarnessLoader;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NgxServerSideMatGridComponent);
    component = fixture.componentInstance;
    loader = TestbedHarnessEnvironment.loader(fixture);
  ...
  it('should test sortOrPageChange (sort)', async () => {
    component.gridConfig = mockGridConfiguration;
    component.displayedColumns = mockDisplayedColumns;
    component.dataSource.setDataSubject(mockGridData);
  ...
  it('should test sortOrPageChange (paginator)', async () => {
    component.gridConfig = mockGridConfiguration;
    component.displayedColumns = mockDisplayedColumns;
    component.dataSource.setDataSubject(mockGridData);
  ...
  it('should test searchInputChange', async () => {
    component.gridConfig = mockGridConfiguration;
    component.displayedColumns = mockDisplayedColumns;
    component.dataSource.setDataSubject(mockGridData);
    component.searchOption = {
