...
@Component({
  selector: 'ngx-server-side-mat-grid',
  templateUrl: './ngx-server-side-mat-grid.component.html',
  styleUrls: ['./ngx-server-side-mat-grid.component.scss']
})
export class NgxServerSideMatGridComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    merge<any>(this.sort.sortChange, this.paginator.page).subscribe((event: Sort | PageEvent) => {
